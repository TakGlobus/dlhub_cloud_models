...
model_info = TensorFlowModel.create_model("./encoder-10021600")

# Define the name and title for the model
model_info.set_title("Encoder part of RI autoencoder trained on 1M MODIS patches from 2000-2020")
